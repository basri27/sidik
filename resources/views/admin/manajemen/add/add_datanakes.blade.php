...
@section('title', 'Tambah Data Tenaga Kesehatan')
...
@section('subhead', 'Tambah Data Tenaga Kesehatan')
        ...
        <div class="card-body">
            <div class="about-row row">
                <div class="detail-col col-md-12">
                    <form method="POST" enctype="multipart/form-data" action="{{ route('adm_man_datanakes_add') }}">
                    @csrf
                    <div class="row">
